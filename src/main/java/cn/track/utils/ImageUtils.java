...
public class ImageUtils implements Serializable {
    ...
    private static String sourceImg = "d://sourceImg.png";
    private static String waterImg = "d://shuiyin2.png";
    private static String outImg = "d://a.png";
    private static double scale = 1.0;
    private static Positions positions = Positions.CENTER;
    private static float opacity = 0.1F;
    private static double quality = 0.8d;


    public static void main(String[] args) {

        try {
            AddWaterMark(sourceImg, waterImg, outImg, scale, positions, opacity, quality);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
